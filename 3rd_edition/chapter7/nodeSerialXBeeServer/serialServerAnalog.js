/*
serialServerAnalog.js
context: node.js

This version works if you're using pin D0 of the sensor radio
as an analog input (ATD02) instead of a digital input.
*/
...
var portName = '/dev/tty.usbserial-00001114';// your port name
...
function parseData(thisPacket) {
  ...
  if (thisPacket.length >= 12) {   // if the packet is 20 bytes long
    ...
    samplesStart = 12;         // ADC reading starts at byte 10
